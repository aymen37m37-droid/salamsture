    ...
    <div class="admin-card-body">
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-mb">
                ...
                <input type="text" name="site_name" class="form-control" value="<?php echo htmlspecialchars($settings['site_name'] ?? 'السلام للعقارات'); ?>">
            </div>
            <div class="form-mb">
                <label class="form-label">الشعار الوصفي (يظهر تحت اسم الموقع)</label>
                <input type="text" name="tagline" class="form-control" value="<?php echo htmlspecialchars($settings['tagline'] ?? ''); ?>" placeholder="نحقق أحلامك العقارية">
            </div>
            <div class="form-mb">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;">
                <div>
                    <div class="form-mb">
                        ...
                        <input type="text" name="cta_title" class="form-control" value="<?php echo htmlspecialchars($settings['cta_title'] ?? 'هل أنت مستعد لامتلاك عقار أحلامك؟'); ?>">
                    </div>
                    <div class="form-mb">
                        <label class="form-label">النص الوصفي</label>
                        <textarea name="cta_subtitle" class="form-control" rows="2"><?php echo htmlspecialchars($settings['cta_subtitle'] ?? 'تواصل معنا الآن واحصل على استشارة مجانية من فريق خبرائنا'); ?></textarea>
                    </div>
                </div>
                <div>
                    <div class="form-mb">
