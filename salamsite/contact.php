...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name) || empty($message)) {
        ...
        $pdo->prepare("INSERT INTO contact_messages (name, email, phone, subject, message, contact_date, status) VALUES (?, ?, ?, ?, ?, datetime('now'), 'جديد')")
                ...
                <div class="contact-item" style="border-top:1px solid rgba(255,255,255,.1);margin-top:10px;padding-top:20px;">
                    ...
                    <div class="contact-item-text">
                        ...
                        <div style="display:flex;gap:12px;margin-top:8px;flex-wrap:wrap;">
                            ...
                            <a href="<?php echo htmlspecialchars($social['facebook']); ?>" target="_blank" style="display:inline-flex;align-items:center;gap:5px;padding:6px 14px;background:#1877F2;color:#fff;border-radius:20px;font-size:13px;font-weight:700;text-decoration:none;">
                                <i class="fab fa-facebook"></i> فيسبوك
                            </a>
                            <?php endif; ?>
                            <?php if ($show('show_twitter') && !empty($social['twitter'])): ?>
                            <a href="<?php echo htmlspecialchars($social['twitter']); ?>" target="_blank" style="display:inline-flex;align-items:center;gap:5px;padding:6px 14px;background:#1DA1F2;color:#fff;border-radius:20px;font-size:13px;font-weight:700;text-decoration:none;">
                                <i class="fab fa-twitter"></i> تويتر
                            </a>
                            <?php endif; ?>
                            <?php if ($show('show_instagram') && !empty($social['instagram'])): ?>
                            <a href="<?php echo htmlspecialchars($social['instagram']); ?>" target="_blank" style="display:inline-flex;align-items:center;gap:5px;padding:6px 14px;background:linear-gradient(45deg,#f09433,#e6683c,#dc2743,#cc2366,#bc1888);color:#fff;border-radius:20px;font-size:13px;font-weight:700;text-decoration:none;">
                                <i class="fab fa-instagram"></i> انستقرام
                            </a>
                            <?php endif; ?>
                            <?php if ($show('show_youtube') && !empty($social['youtube'])): ?>
                            <a href="<?php echo htmlspecialchars($social['youtube']); ?>" target="_blank" style="display:inline-flex;align-items:center;gap:5px;padding:6px 14px;background:#FF0000;color:#fff;border-radius:20px;font-size:13px;font-weight:700;text-decoration:none;">
                                <i class="fab fa-youtube"></i> يوتيوب
                            </a>
                            <?php endif; ?>
                            <?php if ($show('show_linkedin') && !empty($social['linkedin'])): ?>
                            <a href="<?php echo htmlspecialchars($social['linkedin']); ?>" target="_blank" style="display:inline-flex;align-items:center;gap:5px;padding:6px 14px;background:#0077B5;color:#fff;border-radius:20px;font-size:13px;font-weight:700;text-decoration:none;">
                                <i class="fab fa-linkedin"></i> لينكدان
                            </a>
                            <?php endif; ?>
                        </div>
                    </div>
