...
<section class="hero-slider">
    ...
    <div class="slide active">
        ...
        <div class="slide-content">
            <h2>مرحباً بكم في <span><?php echo htmlspecialchars($settings['site_name'] ?? 'السلام للعقارات'); ?></span></h2>
            <p><?php echo htmlspecialchars($settings['tagline'] ?? 'نحقق أحلامك العقارية بأعلى مستويات الجودة والاحترافية'); ?></p>
            <div class="slide-btns">
                <a href="/projects.php" class="btn-primary">استعرض مشاريعنا</a>
...
<section class="services-section">
    <div class="container">
        <div class="section-header">
            ...
            <p>نقدم مجموعة متكاملة من الخدمات العقارية لتلبية كافة احتياجاتكم</p>
        </div>
...
<section class="projects-section">
    <div class="container">
        <div class="section-header">
            ...
            <h2>أبرز مشاريعنا</h2>
            <div class="divider"><i class="fas fa-gem"></i></div>
            <p>نخبة من مشاريعنا العقارية المتميزة التي تشهد على خبرتنا وجودة عملنا</p>
        </div>
        ...
        <div style="text-align:center;margin-top:40px;">
            <a href="/projects.php" class="btn-primary" style="display:inline-block;padding:14px 40px;font-size:16px;font-weight:700;background:var(--dark);color:var(--white);border-radius:4px;">عرض جميع الأعمال</a>
        </div>
    </div>
</section>
<?php endif; ?>
    ...
    <div class="container">
        <div class="about-grid">
            ...
            <div class="about-content-text">
                ...
                <p><?php echo nl2br(htmlspecialchars(mb_substr($about['content'] ?? 'شركة السلام للعقارات، شركة رائدة في مجال التطوير العقاري.', 0, 300))); ?>...</p>
...
<section class="whyus-section">
    <div class="container">
        <div class="section-header">
            ...
            <h2>لماذا تختار <?php echo htmlspecialchars($settings['site_name'] ?? 'السلام للعقارات'); ?>؟</h2>
            <div class="divider"><i class="fas fa-gem"></i></div>
        </div>
...
<section class="cta-strip">
    <div class="container">
        <h2><?php echo htmlspecialchars($settings['cta_title'] ?? 'هل أنت مستعد لامتلاك عقار أحلامك؟'); ?></h2>
        <p><?php echo htmlspecialchars($settings['cta_subtitle'] ?? 'تواصل معنا الآن واحصل على استشارة مجانية من فريق خبرائنا'); ?></p>
        <div class="cta-btns">
